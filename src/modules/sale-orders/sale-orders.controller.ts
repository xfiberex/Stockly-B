...
export const saleOrderController = {
    ...
    async getSaleOrderById(req: Request<{ id: string }>, res: Response, next: NextFunction): Promise<void> {
        try {
    ...
    async exportSaleOrders(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
