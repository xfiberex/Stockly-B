...
> ## Estado al 2026-09-13 — **116 / 129**
>
> **Se abre el [Tier 5](#tier-5--funcionalidad-de-negocio), con 15 tareas, y se cierran las dos primeras:** T5-01,
> coste medio ponderado —con la cancelación de compras recibidas llevada a la interfaz—, y T5-02, valor
> del inventario a coste y margen realizado en dashboard, informe y PDF. No
...
```bash
grep -c '^- \[x\] \*\*\[T' docs/ROADMAP.md    # 116
grep -c '^- \[ \] \*\*\[T' docs/ROADMAP.md    # 13 (el Tier 5, abierto el 2026-09-13)
```
...
|---|---|---|---|
| Tests backend | 198/198 ✅ | **517/517** ✅ *(2026-09-13, T5-02)* | mantener en verde |
| Cobertura backend (sentencias) | 86.92 % | **93.8 %** ✅ *(suelo en 85 %, T2-22)* | ≥ 88 % |
| Tests frontend | 181/181 ✅ | **564/564** ✅ *(+1 omitido: la frescura del contrato sin el repo hermano; 2026-09-13)* | mantener en verde |
| Cobertura frontend (sentencias) | 19.88 % | **70.49 %** ✅ *(suelo subido a 45 % con T4-01)* | ≥ 45 % — **alcanzado** |
